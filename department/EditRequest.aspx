<%@ Page Title="Search Item" Language="C#" MasterPageFile="~/MasterPage/EmployeeConbineMaster.master" AutoEventWireup="true" CodeFile="EditRequest.aspx.cs" Inherits="department_EditRequest" %>
            ...
            <asp:GridView ID="gridView" class="table table-striped table-hover autoCenter  textInCenter" Width="60%" runat="server" AutoGenerateColumns="False" OnRowCommand="gridView_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Order Quantity">
                        <ItemTemplate>
                            <asp:TextBox ID="tbQty" class="form-group centerInput" runat="server" TextMode="Number" Text='<%# Bind("Qty")  %>'></asp:TextBox>
